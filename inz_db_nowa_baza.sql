...
--
-- Host: 127.0.0.1
-- Czas generowania: 07 Lis 2023, 10:42
...
ALTER TABLE `price_read`
  ...
  ADD KEY `fk_Price_Read_User1_idx` (`User_id`);
...
ALTER TABLE `user`
  ...
  ADD UNIQUE KEY `forgotten_password_link_UNIQUE` (`forgotten_password_link`);
...
ALTER TABLE `price_read`
  ...
  ADD CONSTRAINT `fk_Price_Read_User1` FOREIGN KEY (`User_id`) REFERENCES `user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
